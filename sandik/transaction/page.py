...
from sandik.sandik.requirement import sandik_required, sandik_authorization_required
...
def add_money_transaction_page(sandik_id):
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            return redirect(url_for("transaction_page_bp.add_money_transaction_page", sandik_id=sandik_id))
        except Exception as e:
            flash(str(e), "danger")

    return render_template("transaction/add_money_transaction_page.html",
